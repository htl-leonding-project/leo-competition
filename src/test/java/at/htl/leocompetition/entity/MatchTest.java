...
public class MatchTest {
    ...
    public void toString_Test() {
        ...
        assertThat(match.toString()).isEqualTo("Match{matchId=1, team1=Team{teamId=1, teamName='1AHITM', competition=Competition{competitionId=1, date=null}}, team2=Team{teamId=1, teamName='1AHIF', competition=Competition{competitionId=1, date=null}}, pointsTeam1=2, pointsTeam2=1, phase=Phase{phaseId=1, phaseName='phase 1', nodeList=[], competition=Competition{competitionId=1, date=null}}}");
    }
